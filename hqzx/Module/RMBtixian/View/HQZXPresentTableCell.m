...
@interface HQZXPresentTableCell (){
    UIView *infoView;
    UIView *oneInfoView;
    UIView *twoInfoView;
...
@implementation HQZXPresentTableCell
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        twoLable.text = LocatizedStirngForkey(@"TIXIANSHIJIAN");
        ...
        threeLable.text = LocatizedStirngForkey(@"TIXIANZHANGHU");
        ...
        foreLable.text = LocatizedStirngForkey(@"YINHANGKALEIXING");
        ...
        fiveLable.text = LocatizedStirngForkey(@"YINHANGKAHAO");
        ...
        sixLable.text = LocatizedStirngForkey(@"TIXIANJINE");
