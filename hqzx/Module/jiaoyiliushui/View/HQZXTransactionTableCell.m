...
@interface HQZXTransactionTableCell (){
    UIView *infoView;
    UIView *oneInfoView;
    UIView *twoInfoView;
...
@end
@implementation HQZXTransactionTableCell
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        foreLable.text = LocatizedStirngForkey(@"RENMINBISHULIANG");
        ...
        fiveLable.text = LocatizedStirngForkey(@"XUNIBISHULIANG");
...
//        }
        ...
        sevenLable.text = LocatizedStirngForkey(@"PINGJUNCHENGJIAOJIA");
        ...
        eightLable.text = LocatizedStirngForkey(@"SHOUXUFEI");
