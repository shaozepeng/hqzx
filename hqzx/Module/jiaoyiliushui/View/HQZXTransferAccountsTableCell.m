//
//  HQZXTransferAccountsTableCell.m
//  hqzx
//
...
@interface HQZXTransferAccountsTableCell (){
    UIView *infoView;
    UIView *oneInfoView;
    UIView *twoInfoView;
...
@end
@implementation HQZXTransferAccountsTableCell
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    self.rowNum = -1;
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
        self.backgroundColor = TableBgColor;
        UIView *cell = [[UIView alloc] initWithFrame: CGRectMake(0, 0, SCREEN_WIDTH*1.5, SCREEN_WIDTH/8)];
        cell.backgroundColor = UIColorFromRGB(0x0F151B);
        NSString *language = [USER_DEFAULT objectForKey:kUserLanguage];
        
        float cellViewWidth = (cell.width-5)/6.5;
        ...
        twoLable.text = LocatizedStirngForkey(@"LEIBIE");
        ...
        foreLable.text = LocatizedStirngForkey(@"XUNIBISHULIANG");
        ...
        fiveLable.text = LocatizedStirngForkey(@"RENMINBISHULIANG");
        ...
        if([language isEqualToString:@"zh-Hans"]){
            ...
            fiveLable.lineBreakMode = NSLineBreakByCharWrapping;
            fiveLable.numberOfLines = 0;
            fiveLable.font = [UIFont systemFontOfSize: 11];
            [fiveLable setW:fiveInfoView.width-4];
            [fiveLable setH:fiveInfoView.height-6];
            [fiveLable setX:2];
            [fiveLable setY:3];
        }
        ...
        sixLable.text = LocatizedStirngForkey(@"ZHUANGTAI");
        ...
        //七区
        sevenInfoView = [[UIView alloc] initWithFrame: CGRectMake(sixLineView.maxX, 0, cellViewWidth*1.5, cell.height-1)];
        ...
        sevenBonLineView = [[UIView alloc] initWithFrame: CGRectMake(sevenInfoView.x, sevenInfoView.maxY, cellViewWidth*1.5, 1)];
        ...
        sevenLable.text = LocatizedStirngForkey(@"DUIFANGZHANGHAO");
