...
@interface HQZXXNRecordTableCell (){
    UIView *infoView;
    UIView *oneInfoView;
    UIView *twoInfoView;
...
@implementation HQZXXNRecordTableCell
...
//        NSString *language = [USER_DEFAULT objectForKey:kUserLanguage];
        ...
        threeLable.text = LocatizedStirngForkey(@"QIANBAODIZHI");
        ...
        foreLable.text = LocatizedStirngForkey(@"CHONGZHIJINE");
        ...
        fiveLable.text = LocatizedStirngForkey(@"SHOUXUFEI");
