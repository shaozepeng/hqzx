//
//  HQZXChooseCaseWithVewController.m
//  hqzx
//
...
@implementation HQZXChooseCaseWithVewController{
...
-(void)createTableView{
    ...
    [self.myTableView registerClass:[HQZXChooseCaseTableCell class] forCellReuseIdentifier:@"CustomHeaderOne"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HQZXChooseCaseTableCell *cell = [tableView dequeueReusableCellWithIdentifier: CellIdentifier];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HQZXCashWithdrawalViewController *shoukuan=[[HQZXCashWithdrawalViewController alloc]init];
