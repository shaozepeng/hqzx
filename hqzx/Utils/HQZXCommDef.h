...
//api.50f.cn
//#define Userprotocol TESTSTR(@"http://test.www.jianghai56.com/welcome/agreement", @"http://www.jianghai56.com/welcome/agreement")
//#define Serviceagreement TESTSTR(@"http://test.www.jianghai56.com/welcome/seragreement", @"http://www.jianghai56.com/welcome/seragreement")
...
static const double UP_IMG_MAX_SIZES = 1024 * 100;/**< 150 KB */

static const double UP_IMG_MAX_SIZE4HEADERS = 1024 * 20;/**< 15 KB */

@interface HQZXCommDef : NSObject
...
#define IP4566PELSE(_IPHONE4, _IPHONE5,_IPHONE6,_IPHONE6P) (IS_IPHONE_6P?_IPHONE6P:IS_IPHONE_6?_IPHONE6:IS_IPHONE_5?_IPHONE5:_IPHONE4)//判断手机
